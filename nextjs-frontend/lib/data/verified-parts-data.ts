...
export const VERIFIED_PARTS: VerifiedPart[] = [
  // UP-0001: Kubota SVL75/SVL90 Bottom Roller
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Bottom roller, runs down the center of the SVL undercarriage. Length approx 8-1/4 in, outer diameter approx 7-7/8 in, shaft diameter approx 1-3/4 in. 50Mn forged steel with NBR seal. Also referenced as V0511-25100.",
    serial_notes: "Verify exact SVL model/generation before ordering (SVL65-2 / SVL75 / SVL75-2 share this roller).",
  ...
  // UP-0002: CAT 259D Bottom Roller
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Bottom roller, runs down the center of the undercarriage on the CAT 259D/279D/289D/299D D-series CTL frame and earlier B-series. Confirm roller count per side and serial.",
    serial_notes: "Verify exact model and serial from the serial plate before ordering - CAT C/D-series undercarriages can differ.",
    position_notes: "Bottom (lower) roller.",
    source_urls: [
  ...
  // UP-0004: Bobcat T870 Bottom Roller
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Bottom roller for the Bobcat T870 large-frame compact track loader. Confirm roller position and serial; T870 undercarriage parts are specific to this frame.",
    serial_notes: "Verify serial before ordering - parts can vary by serial number on the T870.",
    position_notes: "Bottom (lower) roller.",
    source_urls: [
  ...
  // UP-0005: Kubota SVL65/SVL75 Drive Sprocket
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Drive sprocket: 15 teeth, 9 bolt holes, inside diameter approx 7-7/8 in, outside diameter approx 16-3/4 in, approx 36 lbs. Also referenced as V05210-1110.",
    serial_notes: "Fits SVL65-2 / SVL75 / SVL75-2 / SVL75-2C / SVL75C. Verify tooth count and bolt pattern before ordering.",
  ...
  // UP-0006: Kubota SVL90 Drive Sprocket
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Drive sprocket for the larger SVL90 series: 17 teeth, 9 bolt holes (distinct from the 15-tooth SVL75 sprocket V0511-21110). Confirm tooth count before ordering.",
    serial_notes: "Fits SVL90 / SVL90-2 / SVL90C / SVL90-2C. Verify tooth count (17T) and bolt pattern before ordering.",
    position_notes: "Drive sprocket.",
    source_urls: [
  ...
  // UP-0007: CAT 279C Drive Sprocket
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Drive sprocket for the CAT 279C/279D/289C family (specific to certain serial prefixes - JM etc.). Verify tooth count and bolt pattern.",
    serial_notes: "Specific to certain serial-number prefixes - verify the serial plate before ordering.",
    position_notes: "Drive sprocket.",
    source_urls: [],
    verification_notes: "User-confirmed: imported and sold with no known issue. Use as highest-confidence launch data.",
  ...
  // UP-0008: CAT 239D Drive Sprocket
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Drive sprocket for the CAT 239D/249D/259D family. Verify tooth count and bolt pattern on the customer machine before ordering.",
    serial_notes: "Verify model and serial from the serial plate before ordering.",
    position_notes: "Drive sprocket.",
    source_urls: [],
    verification_notes: "User-confirmed: imported and sold with no known issue. Use as highest-confidence launch data.",
  ...
  // UP-0009: CAT 259B3 Idler
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "TRIPLE-FLANGE front idler for the CAT 259/279/289/299 family. A dual-flange front idler (536-3551) and a single-flange rear idler (304-1894) also exist - confirm flange count and position before ordering.",
    serial_notes: "",
    position_notes: "Front idler, triple flange.",
    source_urls: [],
    verification_notes: "User-confirmed: imported and sold with no known issue. Use as highest-confidence launch data.",
  ...
  // UP-0010: Bobcat T450/T590/T595 Sprocket
  {
    ...
    track_sizes: [],
    chassis_mount_notes: "Drive sprocket: 15 teeth, 15 equally-spaced bolt holes, inside diameter approx 9-1/8 in, outside diameter approx 16-3/8 in (16 in nominal). FLAT style - a dished-style alternative (7166679) exists, so confirm flat vs dished. Works on both solid-mount and suspension undercarriages.",
    serial_notes: "Serial breaks: T550 (AJZV11001 & Above, B57T11001 & Above), T590 (ALJU16825 & above). Bobcat notes parts vary by serial - verify in the Bobcat parts catalog or send serial + photo before ordering.",
    position_notes: "Drive sprocket.",
    source_urls: [],
    verification_notes: "User-confirmed: imported and sold with no known issue. Use as highest-confidence launch data.",
